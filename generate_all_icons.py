...
ICON_SIZES = {
    ...
    # watchOS
    "watchos": [
        {"size": "24x24", "scale": "2x", "pixels": 48, "idiom": "watch", "role": "notificationCenter", "subtype": "38mm"},
        {"size": "27.5x27.5", "scale": "2x", "pixels": 55, "idiom": "watch", "role": "notificationCenter", "subtype": "42mm"},
        {"size": "29x29", "scale": "2x", "pixels": 58, "idiom": "watch", "role": "companionSettings"},
        {"size": "29x29", "scale": "3x", "pixels": 87, "idiom": "watch", "role": "companionSettings"},
        {"size": "33x33", "scale": "2x", "pixels": 66, "idiom": "watch", "role": "notificationCenter", "subtype": "45mm"},
        {"size": "40x40", "scale": "2x", "pixels": 80, "idiom": "watch", "role": "appLauncher", "subtype": "38mm"},
        {"size": "44x44", "scale": "2x", "pixels": 88, "idiom": "watch", "role": "appLauncher", "subtype": "40mm"},
        {"size": "46x46", "scale": "2x", "pixels": 92, "idiom": "watch", "role": "appLauncher", "subtype": "41mm"},
        {"size": "50x50", "scale": "2x", "pixels": 100, "idiom": "watch", "role": "appLauncher", "subtype": "44mm"},
        {"size": "51x51", "scale": "2x", "pixels": 102, "idiom": "watch", "role": "appLauncher", "subtype": "45mm"},
        {"size": "54x54", "scale": "2x", "pixels": 108, "idiom": "watch", "role": "appLauncher", "subtype": "49mm"},
        {"size": "86x86", "scale": "2x", "pixels": 172, "idiom": "watch", "role": "quickLook", "subtype": "38mm"},
        {"size": "98x98", "scale": "2x", "pixels": 196, "idiom": "watch", "role": "quickLook", "subtype": "42mm"},
        {"size": "108x108", "scale": "2x", "pixels": 216, "idiom": "watch", "role": "quickLook", "subtype": "44mm"},
        {"size": "117x117", "scale": "2x", "pixels": 234, "idiom": "watch", "role": "quickLook", "subtype": "45mm"},
        {"size": "129x129", "scale": "2x", "pixels": 258, "idiom": "watch", "role": "quickLook", "subtype": "49mm"},
        {"size": "1024x1024", "scale": "1x", "pixels": 1024, "idiom": "watch-marketing"},
    ],
    # macOS
    "macos": [
...
def adjust_brightness(source, output, brightness_factor):
    ...
    try:
        ...
        subprocess.run([
            "sips", "-s", "brightness", str(brightness_factor), str(source), "--out", str(output)
        ], check=True, capture_output=True)
        return True
...
def generate_all_icons():
    ...
    for size in all_sizes:
        ...
        if not filepath_tinted.exists():
            ...
            if adjust_brightness(filepath_light if filepath_light.exists() else filepath_any, filepath_tinted, 0.1):
                generated_count += 1
