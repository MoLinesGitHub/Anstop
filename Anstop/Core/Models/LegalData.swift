...
Tienes control total sobre tus datos. Puedes eliminar todo tu historial en cualquier
momento desde la sección de Configuración de la aplicación. Al eliminar la aplicación,
también se eliminan todos los datos almacenados localmente.
