...
enum LegalData {
    ...
    **Política de Privacidad**
    ...
    En Anstop, tu privacidad es nuestra prioridad absoluta. Creemos que tu salud mental es un asunto privado,
    por lo que hemos diseñado nuestra aplicación para que tus datos permanezcan bajo tu control.
    ...
    **4. Tus Derechos (GDPR/CCPA)**
    Tienes control total sobre tus datos. Puedes eliminar todo tu historial en cualquier momento desde la
    sección de Configuración de la aplicación. Al eliminar la aplicación, también se eliminan todos los
    ...
    **2. PROPIEDAD INTELECTUAL**
    ...
    Todos los derechos, títulos e intereses en la Aplicación, incluyendo pero no limitado a código fuente,
    diseño, contenido de audio, textos e ilustraciones, son y permanecerán propiedad exclusiva del
    Desarrollador.
    ...
    **3.1. Modelo de Suscripción**
    ...
    Anstop ofrece una versión gratuita y Anstop Premium con renovación automática que desbloquea guías de
    audio ilimitadas, programa de 30 días completo, asistente IA personalizado y análisis avanzado.

    **3.2. Período de Prueba Gratuito**

    Se ofrece un período de prueba gratuito de 7 días para nuevos suscriptores. Si no cancela antes de
    que finalice, se le cobrará automáticamente.

    **3.3. Facturación y Renovación**

    Las suscripciones se cobran a través de su cuenta de Apple ID. La renovación automática ocurre 24
    horas antes del final del período actual. Puede cancelar en cualquier momento desde la configuración
    de su cuenta de Apple. No hay reembolsos por períodos no utilizados.
    ...
    **4. PRIVACIDAD Y PROTECCIÓN DE DATOS**
    ...
    Todos sus datos personales se almacenan exclusivamente en su dispositivo. No transmitimos, recopilamos
    ni almacenamos sus datos en servidores externos. Anstop cumple con GDPR, CCPA y las directivas de
    privacidad de Apple.
    ...
    **5. DESCARGO DE RESPONSABILIDAD MÉDICA**
    ...
    ⚠️ IMPORTANTE: Anstop NO es un dispositivo médico, no está aprobado por la FDA y NO debe utilizarse
    para diagnosticar o tratar condiciones de salud mental. En caso de emergencia, contacte servicios de
    ...
    **6. LIMITACIÓN DE RESPONSABILIDAD**
    ...
    En la máxima medida permitida por la ley, el Desarrollador no será responsable de daños directos,
    indirectos, incidentales, especiales, consecuentes o ejemplares derivados del uso o la imposibilidad
    ...
    **7. TERMINACIÓN**
    ...
    Este EULA es efectivo hasta que sea terminado por usted o por el Desarrollador. Sus derechos bajo este
    EULA terminarán automáticamente si no cumple con los términos. Al terminar, debe dejar de usar y
    ...
    **9. CAMBIOS EN EL EULA**
    ...
    El Desarrollador se reserva el derecho de modificar este EULA en cualquier momento. Los cambios
    entrarán en vigor inmediatamente después de su publicación en la Aplicación. El uso continuado implica
