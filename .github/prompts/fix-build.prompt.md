---
name: /fix-build
description: Analiza y corrige errores de compilación en usando MCP
---

# Fix Build - Corrige errores de compilación

Tengo errores de compilación en el proyecto.

1. Lanza, si es necesario, el tool `run_build_project` en configuración Debug (sin clean) para generar o actualizar el build log.
