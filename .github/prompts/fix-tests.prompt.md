---
name: /fix-tests
description: Investigar y arreglar tests fallidos en usando MCP
---

# Fix Tests - Arregla tests fallidos

Tengo tests fallando en.

1. Usa el tool `run_run_tests` con `testType: "unit"` para obtener el estado actual de los tests y resumir solo los fallidos.
...
4. Sugiere uno o varios comandos de tests para revalidar (por ejemplo `run_run_tests` de nuevo o tests de una feature concreta con `run_automated_feature_tests`).
